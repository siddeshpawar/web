...
function loadSavedData() {
  try {
    ...
    if (saved) {
      ...
      // Deep merge with initialCVData to pick up any new fields added later
      return {
        ...initialCVData,
        ...parsed,
        personalInfo: { ...initialCVData.personalInfo, ...(parsed.personalInfo || {}) },
        dissertation: { ...initialCVData.dissertation, ...(parsed.dissertation || {}) },
        publication: { ...initialCVData.publication, ...(parsed.publication || {}) }
      }
    }
  } catch (e) {
